...
#define PLL_CE_H	HAL_GPIO_WritePin(SYN_CE_GPIO_Port,SYN_CE_Pin,GPIO_PIN_SET)
#define PLL_CE_L	HAL_GPIO_WritePin(SYN_CE_GPIO_Port,SYN_CE_Pin,GPIO_PIN_RESET)

#define PLL_CK_H	HAL_GPIO_WritePin(SYN_SCLK_GPIO_Port,SYN_SCLK_Pin,GPIO_PIN_SET)
#define PLL_CK_L	HAL_GPIO_WritePin(SYN_SCLK_GPIO_Port,SYN_SCLK_Pin,GPIO_PIN_RESET)

#define PLL_DA_H	HAL_GPIO_WritePin(SYN_DATA_GPIO_Port,SYN_DATA_Pin,GPIO_PIN_SET)
#define PLL_DA_L	HAL_GPIO_WritePin(SYN_DATA_GPIO_Port,SYN_DATA_Pin,GPIO_PIN_RESET)

#define PLL_LE_H	HAL_GPIO_WritePin(SYN_CS_GPIO_Port,SYN_CS_Pin,GPIO_PIN_SET)
#define PLL_LE_L	HAL_GPIO_WritePin(SYN_CS_GPIO_Port,SYN_CS_Pin,GPIO_PIN_RESET)

#define PLL_LD()	(HAL_GPIO_ReadPin(LOCK_DETECT_GPIO_Port, LOCK_DETECT_Pin))
